(function () {
    ...
    UM.registerWidget('link', {
        tpl: "<style type=\"text/css\">" +
            ...
            ".edui-dialog-link .edui-link-txt{width:270px;height:26px;line-height:21px;border:1px solid #d7d7d7;}" +
            ".edui-dialog-link .edui-link-table label{margin-left:10px;cursor:pointer}" +
            "</style>" +
            "<table class=\"edui-link-table\">" +
            "<tr>" +
            "<td style=\"text-align: left\"><label for=\"edui-link-Jhref\"><%=lang_input_url%></label></td>" +
            "<td><input dir=\"ltr\" class=\"edui-link-txt\" id=\"edui-link-Jhref\" type=\"text\" /></td>" +
            "</tr>" +
            "<tr>" +
            "<td style=\"text-align: left\"><label for=\"edui-link-Jtitle\"><%=lang_input_title%></label></td>" +
            "<td><input class=\"edui-link-txt\" id=\"edui-link-Jtitle\" type=\"text\"/></td>" +
            "</tr>" +
            "<tr>" +
            "<td colspan=\"2\">" +
            "<input id=\"edui-link-Jtarget\" type=\"checkbox\"/>" +
            "<label for=\"edui-link-Jtarget\" style=\"margin-right:10px\"><%=lang_input_target%></label>" +
            "</td>" +
            "</tr>" +
//            "<tr>" +
